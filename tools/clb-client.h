...
extern void clb_client_create_virtual_server(struct clb_client_t *client);

extern void clb_client_update_virtual_server(struct clb_client_t *client);

extern void clb_client_delete_virtual_server(struct clb_client_t *client);
